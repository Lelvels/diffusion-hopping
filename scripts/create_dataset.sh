#!/bin/bash -l
#SBATCH --job-name=dt_pdbbind_full
...
#SBATCH --gres=gpu:1
#SBATCH --output="/net/scratch/hscra/plgrid/plgkietho/maidung/Code/pharma_res/results/diff_hopp/logs/create_dataset_%j.log"
#SBATCH --error="/net/scratch/hscra/plgrid/plgkietho/maidung/Code/pharma_res/results/diff_hopp/logs/create_dataset_%j.err"
...
# 6. Create dataset
echo "Creating dataset pdbind_full..."
python3 create_dataset.py pdbbind_full